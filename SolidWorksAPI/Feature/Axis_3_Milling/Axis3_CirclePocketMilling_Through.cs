...
namespace SolidWorksAPI
{
    ...
    /// 3轴 -- 圆形凹腔  周长切割
    /// </summary>
    public class Axis3_CirclePocketMilling_Through : Axis3Milling,ICutte
    {
        /// <summary>
        /// 特征直径
        /// </summary>
        ...
        public Axis3_CirclePocketMilling_Through(double Dia,double FeatureDia,double Depth, Materials _Materials)
        {
            this.Dia = Dia;
            this.Depth = Depth;
